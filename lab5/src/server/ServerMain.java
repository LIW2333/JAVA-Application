...
public class ServerMain {
    private JPanel JPanle1 = new JPanel();
    private JList list_users;
    private JButton Button_start = new JButton("start server");
    private JButton Button_stop = new JButton("close server");
    private JTextArea textArea1_msglist;
    private JTextField textField1_msgwrite;
    private JButton button_sendmsg = new JButton("send");
